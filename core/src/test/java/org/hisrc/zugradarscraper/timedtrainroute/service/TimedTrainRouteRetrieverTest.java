...
import org.hisrc.zugradarscraper.trainroute.model.TrainRouteMultiPointFeatureCollection;
...
public class TimedTrainRouteRetrieverTest {
	...
	public void retrievesTrainRoute() throws IOException {
		...
		final TimedTrainRoute trainRoute = sut.retrieve(new TrainId("ICE", "654", "84/121947/18/19/80", LocalDate.of(2017, 5, 6)), LocalDate.of(2017, 5, 6));
